...
export function AdminDashboardContent() {
  ...
  try {
    ...
    console.error('[AdminDashboardContent] Error in component:', error);
    return (
      <div className="container mx-auto p-6">
        <div className="bg-destructive/10 p-4 rounded-md">
          <h2 className="font-semibold text-destructive mb-2">Dashboard Error</h2>
          <p>Failed to load dashboard components. Please refresh the page.</p>
