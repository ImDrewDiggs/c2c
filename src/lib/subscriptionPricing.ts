/**
 * Subscription pricing (client display) — Can2Curb Pricing Guide.
 * Mirrors supabase/functions/_shared/subscriptionPricing.ts. The server recomputes and is authoritative.
 */
