/**
 * Subscription pricing (client display).
 * Mirrors supabase/functions/_shared/subscriptionPricing.ts — keep both in sync. The server recomputes and is authoritative.
 */
